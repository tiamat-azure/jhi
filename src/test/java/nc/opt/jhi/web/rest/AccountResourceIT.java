package nc.opt.jhi.web.rest;

import static nc.opt.jhi.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import nc.opt.jhi.IntegrationTest;
import nc.opt.jhi.config.Constants;
import nc.opt.jhi.domain.User;
import nc.opt.jhi.repository.AuthorityRepository;
import nc.opt.jhi.repository.UserRepository;
import nc.opt.jhi.security.AuthoritiesConstants;
import nc.opt.jhi.service.UserService;
import nc.opt.jhi.service.dto.AdminUserDTO;
import nc.opt.jhi.service.dto.PasswordChangeDTO;
import nc.opt.jhi.service.dto.UserDTO;
import nc.opt.jhi.web.rest.vm.KeyAndPasswordVM;
import nc.opt.jhi.web.rest.vm.ManagedUserVM;
