package nc.opt.jhi.config.timezone;
...
import nc.opt.jhi.repository.timezone.DateTimeWrapper;
import nc.opt.jhi.repository.timezone.DateTimeWrapperRepository;
